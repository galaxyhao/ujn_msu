                                ...
                                <tbody>
                                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="/ujn_msu/index.php/Msu/Web/payRecord/dnsname/<?php echo ($data["dnsname"]); ?>" class="btn btn-danger btn-sm">缴费记录</a>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form class="form-horizontal" role="form" action="/ujn_msu/index.php/Msu/Web/web_pay" method="post">
                                                ...
                                                <a href="/ujn_msu/index.php/Msu/Web/edit/dnsname/<?php echo ($data["dnsname"]); ?>" class="btn btn-sm btn-primary"><i class="fa fa-pencil-square-o"></i>&nbsp;编辑</a>
                                            </td>
    ...
    <script>
        $(function(){
            ...
            $(".jiaofei").click(function(){
                ...
                submit(select,'/ujn_msu/index.php/Msu/Web/web_pay','POST','缴费成功！');
            });
        })
    </script>
</body>
