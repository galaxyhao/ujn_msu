                    ...
                    <table class="table  table-hover table-striped">
                        ...
                        <tbody>
                            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td><a href="/ujn_msu/index.php/Msu/Weihu/client_record/id/<?php echo ($vo["id"]); ?>"><?php echo ($vo["building"]); echo ($vo["unit"]); echo ($vo["room"]); ?></a></td>
                ...
                <div class="modal fade" id="add<?php echo ($vo["id"]); ?>" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                         ...
                         <!-- Modal Body -->
                         <div class="modal-body">
                            <form class="form-horizontal" role="form" action="/ujn_msu/index.php/Msu/Weihu/note_save" method="post">
                                <div class="form-group">
...
<div class="row">
    ...
    <div class="col-lg-4 col-md-6">
        <div class="panel panel-green">
            ...
            <a href="/ujn_msu/index.php/Msu/weihu/weihu_list_yes">
                <div class="panel-footer">
                    <span class="pull-left">View Details</span>
                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                    <div class="clearfix"></div>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="text-right">
                                    <a href="/ujn_msu/index.php/Msu/Count">查看全部工作量统计 <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $(function(){
            $('.tianxie').click(function(){
             ...
             submit(select,"/ujn_msu/index.php/Msu/Weihu/weihu_submit",'POST','填写成功！');
         });
            $('.buchong').click(function(){
             var select = $(this).parents('form');
             
             submit(select,"/ujn_msu/index.php/Msu/Weihu/note_save",'POST','填写成功！');
         });
