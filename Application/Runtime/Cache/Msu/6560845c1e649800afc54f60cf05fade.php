...
<head>
    ...
    <link href="/ujn_msu/Public/css/particles.css" rel="stylesheet">
...
<body>
  ...
  <div id="particles-js">
              ...
              <div class="col-md-3 col-md-offset-8">
                  <div class="login-panel panel panel-default">
                      ...
                      <div class="panel-body">
                          <form role="form" action="/ujn_msu/index.php/Msu/Login/checkin" method="post">
                              <fieldset>
    ...
    <script src="/ujn_msu/Public/js/bootstrap.min.js"></script>
        ...
        <script>
            particlesJS.load('particles-js', '/ujn_msu/Public/js/particles.json', function() {
