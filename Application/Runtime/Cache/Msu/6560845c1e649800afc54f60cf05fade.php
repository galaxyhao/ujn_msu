...
<head>
    ...
    <link href="/ujn-msu/ujn_msu/Public/css/particles.css" rel="stylesheet">
...
<body>
  ...
  <div id="particles-js">
              ...
              <div class="col-md-3 col-md-offset-8">
                  <div class="login-panel panel panel-default">
                      <div class="panel-heading">
                          <h3 class="panel-title"><center>网络维护系统</center></h3>
                      </div>
                      <div class="panel-body">
                          <form role="form" action="/ujn-msu/ujn_msu/index.php/Msu/Login/checkin" method="post">
                              <fieldset>
    ...
    <script src="/ujn-msu/ujn_msu/Public/js/bootstrap.min.js"></script>
        ...
        <script>
            particlesJS.load('particles-js', '/ujn-msu/ujn_msu/Public/js/particles.json', function() {
